...
const en = {
  ...
  footer: {
    ...
    license: "MIT",
    version: "v",
    note: "Replay of committed artifacts; semantic search runs live in the browser.",
  },
  ...
  live: {
    intro: "Type a query and search all datasets by meaning · the multilingual encoder runs in the browser (ONNX Runtime Web), no server. Or reweight the affinity evidences and watch the ranking recompute live.",
    badge: "computed live in the browser",
    ...
    fallbackBody: "Free-text search needs the ONNX encoder. Until it loads, 'datasets similar to this one' can still be explored using the baked embeddings.",
  },
  viz: {
    datasets: "datasets",
    edges: "relations",
...
const es: typeof en = {
  ...
  footer: {
    ...
    license: "MIT",
    version: "v",
    note: "Reproducción de artefactos versionados; la búsqueda semántica se ejecuta en vivo en el navegador.",
  },
  common: { loading: "Cargando…", error: "No se pudo cargar", none: "Sin datos", of: "de", showing: "Mostrando" },
  arch: {
    title: "Arquitectura · cómo funciona",
    subtitle: "Qué se ejecuta dónde, los motores y los contratos de datos · todo el sistema de un vistazo.",
    open: "Arquitectura / cómo funciona",
    close: "Cerrar",
    footer: "El pipeline offline mina el grafo; la web reproduce artefactos versionados y ejecuta búsqueda semántica en vivo.",
  },
  app: {
    caseSelector: "Vista analítica",
    variants: "Variantes",
    tabField: "Vista",
    tabLive: "En vivo (en el navegador)",
    tabCharts: "Comparar",
    tabContext: "Contexto",
    category: "Categoría",
    engines: "Motores",
    stats: "Resumen",
    readout: "Valores al pasar el cursor",
  ...
  live: {
    intro: "Una consulta de texto busca todos los datasets por significado · el codificador multilingüe se ejecuta en el navegador (ONNX Runtime Web), sin servidor. Las evidencias de afinidad también se pueden re-ponderar y el ranking se recomputa en vivo.",
    badge: "calculado en vivo en el navegador",
    ...
    fallbackBody: "La búsqueda de texto libre necesita el codificador ONNX. Hasta que cargue se pueden explorar 'datasets similares a este' con los embeddings precalculados.",
  },
  viz: {
    datasets: "datasets",
    edges: "relaciones",
