...
export const ARCH_TABS: ArchTab[] = [
  ...
  },
  {
    ...
    body: {
      ...
      es: [
        "La SPA (React 19 + Vite) tiene seis páginas: Explorador (el workbench), Introducción, Metodología, Implementación, Experimentos y Benchmark. El Explorador abre en la red semántica y ofrece ocho lentes con nombre (mapa del catálogo, red semántica, unibilidad, correlaciones, geografía, tiempo, calidad, afinidad), cada una una vista de dominio genuina.",
        ...
        "En el build, copy-data.mjs superpone el data/derived commiteado en la SPA. El carril en vivo corre el codificador ONNX MiniLM en el navegador (transformers.js / onnxruntime-web) con el re-pesado de afinidad en JS puro; todo lo demás es replay de artefactos precalculados. El sitio estático se sirve como archivos estáticos (nginx / vps-static para la instancia en vivo; GitHub Pages igualmente soportado), sin backend, sin base de datos.",
      ],
    },
  },
  {
