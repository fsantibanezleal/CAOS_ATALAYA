  ...
  },
  {
    ...
    body: {
      ...
      es: [
        ...
        "En el build, copy-data.mjs superpone el data/derived commiteado en la SPA. El carril en vivo corre el codificador ONNX MiniLM en el navegador (transformers.js / onnxruntime-web) con el re-pesado de afinidad en JS puro; todo lo demás es replay de artefactos horneados. El sitio estático se sirve como archivos estáticos (nginx / vps-static para la instancia en vivo; GitHub Pages igualmente soportado), sin backend, sin base de datos.",
      ],
    },
  },
  {
