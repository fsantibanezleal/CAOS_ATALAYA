...
export const ARCH_TABS: ArchTab[] = [
  ...
  },
  {
    ...
    body: {
      ...
      es: [
        "Las relaciones se minan, no se afirman. SEMÁNTICA: embeddings de oraciones MiniLM, coseno sobre un umbral. UNIBLE: firmas MinHash de columnas clave, ordenadas por contención de conjuntos (una tabla pequeña se une a una grande cuando sus claves están contenidas), siguiendo la idea Auctus/Lazo/LSH-Ensemble. ESPACIAL: claves comuna/región compartidas o coordenadas en la misma zona. SAME_SOURCE: editor compartido.",
