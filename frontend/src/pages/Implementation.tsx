  ...
  return (
    <div className="page-body">
      ...
      <div className="prose measure">
        ...
        <p>{es ? "El espejo de archivos directos ocupa ~21 GB en disco (fuera de git); cada artefacto de lente comprometido es <1 MB (la tabla de embeddings de ~3 MB se carga de forma diferida solo para la búsqueda en vivo) por lo que la primera pintura es instantánea. El codificador ONNX cuantizado se descarga una vez y se cachea. Los datasets pesados y los modelos viven fuera de git; solo los artefactos compactos se comprometen." : "The direct-file mirror is ~21 GB on disk (out-of-git); each committed lens artifact is <1 MB (the ~3 MB embedding table is lazy-loaded only for live search) so first paint is instant. The quantized ONNX encoder downloads once and is cached. Heavy datasets and models live out-of-git; only the compact artifacts are committed."}</p>
