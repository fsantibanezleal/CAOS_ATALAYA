  ...
  return (
    <div className="page-body">
      ...
      <div className="prose measure">
        ...
        <p>{es
          ? "Un pipeline offline descarga el subconjunto de archivos directos del catálogo, perfila cada tabla (esquema, estadísticas, claves de entidad chilenas, embeddings), y mina cinco tipos de relación entre datasets: mismo origen, similitud semántica, unibilidad, solape geográfico y correlación estadística. Todo se resume en un grafo de conocimiento que la web reproduce, más una propuesta novel que fusiona las evidencias en un score de afinidad calibrado. La web expone todo esto como ocho lentes explorables (mapa del catálogo, red semántica, unibilidad, correlaciones, geografía, tiempo, calidad y afinidad), abriendo en la red semántica."
          : "An offline pipeline downloads the catalog's direct-file subset, profiles every table (schema, statistics, Chilean entity keys, embeddings), and mines five kinds of dataset relation: same source, semantic similarity, joinability, geographic overlap and statistical correlation. It all rolls up into a knowledge graph the web replays, plus a novel proposal that fuses the evidences into a calibrated affinity score. The web surfaces all of this as eight explorable lenses (catalog map, semantic network, joinability, correlations, geography, time, data quality and affinity), opening on the semantic network."}</p>
