      ...
      <SubTabs ariaLabel="methodology" tabs={[
        {
          ...
          content: (
            <div className="prose measure">
              ...
              <p>{es ? "Para el mapa, proyectamos con PCA (las dos componentes de mayor varianza; un toggle 2D/3D también expone un layout PCA de 3 componentes para orbitar); para agrupar, k-means sobre los embeddings." : "For the map we project with PCA (the two highest-variance components; a 2D/3D toggle also exposes a 3-component PCA layout to orbit); to group, k-means over the embeddings."}</p>
