// LIVE lane (optional, Pyodide): load the inlined atalayalab sources (public/pyodide/sources.json) and call
// atalayalab.live.run_trace_json for a bring-your-own-params interaction in the browser. This is a STUB — a real
